    ...
    var search = function () {
        table.render({
            ...
            cols: [[
                ...
                {field: 'PARTNER_NAME', width: 100, title: '接口版本号'},
                {field: 'PARTNER_TYPE', width: 100, title: '请求流水号', sort: true},
                {field: 'SALER', width: 100, title: '用户标识', sort: true,hide:true},
                {field: 'LEGAL_NAME', width: 100, title: '用户名称', sort: true,hide:true},
                {field: 'LEGAL_ID', width: 100, title: '签约结果', sort: true,hide:true},
                {field: 'LEGAL_PHONE', width: 100, title: '流水号', sort: true,hide:true},
                {field: 'CONTACTOR', width: 100, title: '签名', sort: true,hide:true},
                {field: 'CONTACT_PHONE', width: 100, title: '请求时间', sort: true,hide:true}
            ]]
        });
